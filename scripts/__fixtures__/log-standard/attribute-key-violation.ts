...
const ATTRS = { TURN_ID: 'namzu.turn.id' } as const
...
const WIDENED = { TURN_ID: 'namzu.turn.id' }
...
export function demo(log: Logger, id: string) {
	...
	// "namzu.turn.id" and passes. This is the shape every real call site
