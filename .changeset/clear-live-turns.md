...
handles are session-owned rather than directly constructible, and independent
speech drivers correlate final transcripts to VAD intervals by their shared
source timestamp instead of callback order. The initial package supports
