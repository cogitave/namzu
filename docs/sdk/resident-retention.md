...
adds the [durable pause generation](resident-agents.md). Schema 6 retains pending
wake evidence. Schemas 1–5 read without invented history or learned state;
new writes use schema 6.
