...
title: "@namzu/openai"
description: >-
  The OpenAI model driver for @namzu/sdk. Wraps the official openai client and
  implements the LLMProvider contract over the Chat Completions API — one
  streaming entry point, tool use, images and documents. Separate from the
  kernel so a consumer who never calls this vendor installs no vendor client.
...
**The OpenAI driver for [`@namzu/sdk`](https://www.npmjs.com/package/@namzu/sdk).**
...
[![npm](https://img.shields.io/npm/v/@namzu/openai.svg?label=%40namzu%2Fopenai)](https://www.npmjs.com/package/@namzu/openai)

[Install](#install) · [Use it](#use-it) · [Configuration](#configuration) · [Capabilities](#capabilities) · [What it refuses](#what-it-refuses) · [Errors](#errors) · [Compatible endpoints](#openai-compatible-endpoints)
...
kernel version and one copy is shared with every other driver. The `openai`
client (`^6.0.0`) is an ordinary dependency and arrives with this package.
