...
# @namzu/openai Release Script (local orchestration)
#
# Usage:
#   Stable releases:
...
git commit -m "chore(release): openai ${VERSION}"
git tag -a "$TAG" -m "Release @namzu/openai ${VERSION}"
