...
# @namzu/ollama Release Script (local orchestration)
#
# Usage:
#   Stable releases:
...
git commit -m "chore(release): ollama ${VERSION}"
git tag -a "$TAG" -m "Release @namzu/ollama ${VERSION}"
