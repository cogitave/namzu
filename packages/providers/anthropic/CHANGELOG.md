...
- a729b17: The error a stalled stream raises now says the turn lifecycle can emit
...
- 786ca01: Keep the optional Claude Code version probe out of framework filesystem
...
- fdd76aa: Honor responseFormat.json_schema in direct provider calls by sending output_config.format without overwriting reasoning effort. Previously the requested format was silently ignored. Schemas are forwarded unchanged; callers remain responsible for vendor-compatible schemas and checking the response.
