...
# @namzu/anthropic Release Script (local orchestration)
#
# Usage:
#   Stable releases:
...
git commit -m "chore(release): anthropic ${VERSION}"
git tag -a "$TAG" -m "Release @namzu/anthropic ${VERSION}"
