...
# @namzu/openrouter Release Script (local orchestration)
#
# Usage:
#   Stable releases:
...
git commit -m "chore(release): openrouter ${VERSION}"
git tag -a "$TAG" -m "Release @namzu/openrouter ${VERSION}"
