...
# @namzu/bedrock Release Script (local orchestration)
#
# Usage:
#   Stable releases:
...
git commit -m "chore(release): bedrock ${VERSION}"
git tag -a "$TAG" -m "Release @namzu/bedrock ${VERSION}"
