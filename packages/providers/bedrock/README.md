...
title: "@namzu/bedrock"
description: >-
  The AWS Bedrock driver for @namzu/sdk. Speaks the Converse streaming wire
  through @aws-sdk/client-bedrock-runtime, maps tool use and prompt caching,
  and refuses a model id this wire cannot reach before anything leaves the
  process. Separate from the kernel so only a consumer who calls Bedrock
  installs the AWS SDK.
tags: [readme, package, provider, bedrock, aws]
...
**The AWS Bedrock driver for [`@namzu/sdk`](https://www.npmjs.com/package/@namzu/sdk).**
...
[![npm](https://img.shields.io/npm/v/@namzu/bedrock.svg?label=%40namzu%2Fbedrock)](https://www.npmjs.com/package/@namzu/bedrock)

[Install](#install) · [Use it](#use-it) · [Model ids](#model-ids) · [Credentials](#credentials-and-region) · [Caching](#prompt-caching) · [Capabilities](#capabilities) · [Health](#health) · [Errors](#errors)
