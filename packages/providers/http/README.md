...
title: "@namzu/http"
description: >-
  The bring-your-own-endpoint driver for @namzu/sdk. Speaks either the OpenAI
  Chat Completions wire or the native Anthropic Messages wire over native fetch
  with no runtime dependencies at all, and refuses rather than guesses when the
  response shape does not match the dialect you declared.
...
**The bring-your-own-endpoint driver for [`@namzu/sdk`](https://www.npmjs.com/package/@namzu/sdk).**
...
[![npm](https://img.shields.io/npm/v/@namzu/http.svg?label=%40namzu%2Fhttp)](https://www.npmjs.com/package/@namzu/http)

[Install](#install) · [Use it](#use-it) · [Dialects](#two-dialects) · [Config](#configuration) · [Capabilities](#capabilities) · [Models and health](#models-and-health) · [Errors](#errors)
