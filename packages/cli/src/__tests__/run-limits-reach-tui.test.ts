...
it.each([
	{
		args: [],
		limits: { tokenBudget: 2_000, maxIterations: 3, timeoutMs: 1000 },
	},
	{ args: [], limits: { tokenBudget: 0, maxIterations: 0, timeoutMs: 0 } },
	{
		args: ['resume', '321be44d-6691-4832-b399-013abc59d851'],
		limits: { tokenBudget: 0, maxIterations: 0, timeoutMs: 0 },
	},
])(
	...
	async ({ args, limits }) => {
		...
		expect(resolveTrustedProjectContext(bootstrap, cwd).limits).toEqual(limits)
	},
)
