...
async function run(provider: MockLLMProvider, over: Record<string, unknown> = {}): Promise<void> {
	...
	await drainQuery({
		...
		sessionId: '9724f6f9-f974-4e61-b776-8d20ca507839' as SessionId,
		topicId: '2b5262db-e8f7-47d8-96c8-50b38a7333b3' as TopicId,
		projectId: '07a1c072-7e60-4cef-b9d2-57eea021feb5' as ProjectId,
		tenantId: 'eb553982-17b2-4c52-a9f7-3e2cf58c967b' as TenantId,
