...
describe('the tool-retry backoff a caller sets reaches the executor', () => {
	...
	async function run(extra: Record<string, unknown>) {
		...
		return drainQuery({
			...
			sessionId: 'f72f19ec-f321-49d6-9797-5e0607be2ca1' as SessionId,
			topicId: 'ad3adcfd-a2cd-47c7-80ff-d3424c05885d' as TopicId,
			projectId: '6a2eb356-e7e5-4f2c-9110-cbb4b66770d9' as ProjectId,
			tenantId: '464d44b5-2bac-41e8-ab85-2cea9200a32e' as TenantId,
