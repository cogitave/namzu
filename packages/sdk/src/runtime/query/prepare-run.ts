...
import type { CheckpointId, PlanId } from '../../types/ids/index.js'
...
import { type RunContext, RunContextFactory } from './context.js'
...
export interface PreparedRun {
	...
	readonly approvalPolicy: RunApprovalPolicy
...
export type SelectedResumeState = RunState & {
...
export async function prepareRun(params: QueryParams): Promise<PreparedRun> {
