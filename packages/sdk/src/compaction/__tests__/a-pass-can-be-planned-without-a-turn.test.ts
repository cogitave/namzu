...
/**
 * The compaction pass, asked without a turn.
 *
...
describe('a compaction pass can be planned without a turn', () => {
	...
	it('refuses when every candidate cut would split a tool pair', () => {
		...
		// and the provider rejects the next turn — compaction killing the turn
	...
	it('holds no reference to an iteration context', () => {
		...
		// silently re-couple the arithmetic to a live turn — which is the one
