...
async function supervise(opts: {
	...
	return (await agent.run(
		...
		} as never,
		{
			...
			timeoutMs: 30_000,
			maxIterations: 4,
			sessionId: '8d0e42eb-2386-4132-8d3a-cf1b0dc32375',
			topicId: '80a023ab-f66c-477b-82a9-09a74c6bbc18',
			projectId: '66a326d8-5f2f-467d-b3ac-35fe431a9d7c',
			tenantId: '07442843-84b9-4ee1-81db-b1f7db0ae95d',
